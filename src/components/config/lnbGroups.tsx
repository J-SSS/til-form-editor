import { LnbGroup } from '../fsFormStudio.types';
...
export const createLnbSelectGroups = (
  ...
  },
  {
    title: '선택 항목',
    items: [
      { id: 'listbox', icon: '▾', label: '셀렉트 박스', action: () => { addElementToSelection('select', 'SelectBox'); } },
      { id: 'check', icon: '☑', label: '체크 박스', action: () => { addElementToSelection('checkbox', 'CheckBox'); } },
      { id: 'radio', icon: '◉', label: '라디오 버튼', action: () => { addElementToSelection('radio', 'RadioButton'); } },
    ],
  },
  {
    title: '표시 항목',
