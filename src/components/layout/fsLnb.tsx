...
import { clearJsEditorPopupBridge, openJsEditorPopup } from './fsScriptEditor';
...
const FsLnb: React.FC<LNBProps> = ({ lnbTab, lnbGroups, onChangeTab, onOpenSettings }) => {
